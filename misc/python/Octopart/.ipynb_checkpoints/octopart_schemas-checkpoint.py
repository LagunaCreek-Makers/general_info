...
class Asset:
    ...
    def download(self):
        if self.url is None or self.data is not None:
            return
...
class ImageSet:
    ...
    def download(self):
        if self.swatch_image is not None:
            self.swatch_image.download()
        
        if self.small_image is not None:
            self.small_image.download()
        
        if self.medium_image is not None:
            self.medium_image.download()
        
        if self.large_image is not None:
            self.large_image.download()
        return
...
class Part:
    ...
    def __str__(self):
        ...
        if self.short_description is not None:
            string +="Short Description: {0}\n".format(self.short_description)
        return string
    
    def download_all(self):
        if self.imagesets is not None:
            for i in self.imagesets:
                i.download()
        ...
        if self.compliance_documents is not None:
            for i in self.compliance_documents:
                i.download()
        
        if self.reference_designs is not None:
            for i in self.reference_designs:
                i.download()
        
        if self.cad_models is not None:
            for i in self.cad_models:
                i.download()
...
class PartsMatchResult:
    def __init__(self, data):
        self.items = [Part(x) for x in data['items']]
        self.hits = data['hits']
        self.reference = data['reference']
